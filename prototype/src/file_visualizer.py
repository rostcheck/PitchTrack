...
Main visualization application with piano roll style display and connected pitch lines.
Features enhanced vocal pitch tracking and real-time audio playback.
"""
